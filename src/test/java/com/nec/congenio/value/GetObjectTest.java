...
public class GetObjectTest {
    ...
    public void testCreateArrayValue() {
        ConfigValue[] vals = { entity(1), entity(2), entity(3) };
        ConfigValue value = Values.builder("test")
                .add("entities", vals)
                .add("name", "testparent")
                .build();
    ...
    public void testCreateWithProperties() {
        ...
        ConfigValue value =
                ...
                .add("params", prop)
                .build();
        TestProp testProp = value.toObject(TestProp.class);
        assertEquals(prop, testProp.getParams());
    }
